...
#define BITS(num, range) ((((0xFFFFFFFF >> (31 - (1 ? range))) & \
			...
			(0 ? range))
#define HIGH32BITS(val64bit) ((ScU32)(val64bit >> 32))
#define LOW32BITS(val64bit) ((ScU32)(val64bit))
...
ScS32 ape_get_dma_address(void *driver_context, void *task_data,
					ScS16 index, void *dst_ptr,
					ScU32 destination);
...
ape_get_dma_cube_address(void *driver_context, void *task_data,
						...
						ScU32 destination);
ScS32
ape_read_input_address(struct data_cube *data,ScU64 *address);
