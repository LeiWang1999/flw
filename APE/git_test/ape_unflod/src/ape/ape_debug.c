...
static void
ape_debug_data_cube(struct data_cube *cube)
{
	LOG_DEBUG("    type          = %u\n", cube->type);
	LOG_DEBUG("    address       = %d\n", cube->address);
	LOG_DEBUG("    width         = %d\n", cube->width);
...
static void
ape_debug_converter(struct cvt_param *cvt)
{
...
{
	LOG_DEBUG("*********************************************************\n");
	//LOG_DEBUG("APE FW ROI[%d]: ape_conv_surface_desc\n", roi);
	LOG_DEBUG("---------------------------------------------------------\n");
	LOG_DEBUG("weight_data         = [ data_cube =>\n");
	ape_debug_data_cube(&desc->weight_data);
	LOG_DEBUG("wmb_data            = [ data_cube =>\n");
	ape_debug_data_cube(&desc->wmb_data);
	LOG_DEBUG("wgs_data            = [ data_cube =>\n");
	ape_debug_data_cube(&desc->wgs_data);
	LOG_DEBUG("src_data            = [ data_cube =>\n");
	ape_debug_data_cube(&desc->src_data);
	LOG_DEBUG("dst_data            = [ data_cube =>\n");
	ape_debug_data_cube(&desc->dst_data);
...
{
	LOG_DEBUG("*********************************************************\n");
	LOG_DEBUG("APE FW ROI[%d]: ape_sdp_surface_desc\n", roi);
	LOG_DEBUG("---------------------------------------------------------\n");
	LOG_DEBUG("src_data            = [ ape_data_cube =>\n");
	ape_debug_data_cube(&desc->src_data);
	LOG_DEBUG("x1_data             = [ ape_data_cube =>\n");
	ape_debug_data_cube(&desc->x1_data);
	LOG_DEBUG("x2_data             = [ ape_data_cube =>\n");
	ape_debug_data_cube(&desc->x2_data);
	LOG_DEBUG("y_data              = [ ape_data_cube =>\n");
	ape_debug_data_cube(&desc->y_data);
	LOG_DEBUG("dst_data            = [ ape_data_cube =>\n");
	ape_debug_data_cube(&desc->dst_data);
}
...
{
	LOG_DEBUG("*********************************************************\n");
	LOG_DEBUG("APE FW ROI[%d]: ape_pdp_surface_desc\n", roi);
	LOG_DEBUG("---------------------------------------------------------\n");
	LOG_DEBUG("src_data            = [ ape_data_cube =>\n");
	ape_debug_data_cube(&desc->src_data);
	LOG_DEBUG("dst_data            = [ ape_data_cube =>\n");
...
{
	LOG_DEBUG("*********************************************************\n");
	LOG_DEBUG("APE FW ROI[%d]: ape_cdp_surface_desc\n", roi);
	LOG_DEBUG("---------------------------------------------------------\n");
	LOG_DEBUG("src_data            = [ ape_data_cube =>\n");
	ape_debug_data_cube(&desc->src_data);
	LOG_DEBUG("dst_data            = [ ape_data_cube =>\n");
...
{
	LOG_DEBUG("*********************************************************\n");
	LOG_DEBUG("APE FW ROI[%d]: ape_conv_op_desc\n", roi);
	LOG_DEBUG("---------------------------------------------------------\n");
	...
	LOG_DEBUG("pad_val            = %d\n", desc->pad_val);
	LOG_DEBUG("in_cvt             =\n");
	ape_debug_converter(&desc->in_cvt);
	LOG_DEBUG("out_cvt            =\n");
	ape_debug_converter(&desc->out_cvt);
}
...
static void
ape_debug_sdp_op(struct sdp_op *sdp_op)
{
	LOG_DEBUG("    enable         = %u\n", sdp_op->enable);
	...
	ape_debug_converter(&sdp_op->cvt.alu_cvt);
	LOG_DEBUG("cvt.mul_cvt          =\n");
	ape_debug_converter(&sdp_op->cvt.mul_cvt);
	LOG_DEBUG("]\n");
}
...
{
	LOG_DEBUG("*********************************************************\n");
	LOG_DEBUG("APE FW ROI[%d]: ape_sdp_op_desc\n", roi);
	LOG_DEBUG("---------------------------------------------------------\n");
	...
	LOG_DEBUG("batch_stride     = %u\n", desc->batch_stride);
	LOG_DEBUG("x1_op            = [ ape_sdp_op =>\n");
	ape_debug_sdp_op(&desc->x1_op);
	LOG_DEBUG("x2_op            = [ ape_sdp_op =>\n");
	ape_debug_sdp_op(&desc->x2_op);
	LOG_DEBUG("y_op             = [ ape_sdp_op =>\n");
	ape_debug_sdp_op(&desc->y_op);
}
...
{
	LOG_DEBUG("*********************************************************\n");
	LOG_DEBUG("APE FW ROI[%d]: ape_cdp_op_desc\n", roi);
	LOG_DEBUG("---------------------------------------------------------\n");
	LOG_DEBUG("in_precision      = %u\n", desc->in_precision);
	LOG_DEBUG("out_precision     = %u\n", desc->out_precision);
	LOG_DEBUG("lut_index         = %d\n", desc->lut_index);
